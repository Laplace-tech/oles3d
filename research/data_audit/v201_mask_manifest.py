"""공식 TotalSegmentator v2.0.1 total task의 고정 class-name 목록."""

# v2.0.1 tag를 해석한 commit; network 없이 감사에 사용
# https://github.com/wasserth/TotalSegmentator/blob/2c53561165b951c19e962123daf4496c4f52ac1a/totalsegmentator/map_to_binary.py
SOURCE_COMMIT = "2c53561165b951c19e962123daf4496c4f52ac1a"

TOTAL_V201_MASKS: tuple[str, ...] = (
    ...
    "prostate", "kidney_cyst_left", "kidney_cyst_right", "sacrum",
